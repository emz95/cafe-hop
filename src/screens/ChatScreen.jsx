...
/*The fetch api calls and their surroundings function were coded using AI 
prompts can be found at the bottom of this page 
Large chunks of this page are generated by AI due to an inactive 
team member responsible for this feature 
The react components and UI elements were coded by a human 
*/
...
const ChatScreen = () => {
  ...
  // AI Generated Helper: format chat list timestamp
  ...
  // Ai Generated Helper: format message timestamp
  ...
  // 🔹 AI Generated Fetch all chats for the current user
  useEffect(() => {
    if (!userId || !token) {
    ...
    //AI generated function for displaying chats
  ...
  // 🔹 AI GEnerated Fetch messages for a specific chat
  ...
  // 🔹 AI generated Poll for new messages every 1 second while a chat is open
  useEffect(() => {
  ...
  // 🔹 AI generated Send a real message
  ...
  return (
    <div className="chat-screen">
      ...
      <div className="main-content">
        {!selectedChat ? (
          // 🔹 AI generated Chat list view (UI elements done by human)
          <>
          ...
          // 🔹 AI Generated Individual chat view (UI elements done by human)
          <>
...
/*
Using fetch API to the endpoints defined in the group chats controller, edit the frontend ChatScreen.jsx to implement the following features:
1. Display a list of group chats the user is part of, showing the chat name and last message timestamp
2. Allow the user to click on a chat to view messages in that chat
3. Fetch and display messages for the selected chat, showing sender name, message text, and timestamp
4. Provide an input field to send new messages in the selected chat
5. Implement error handling and loading states for fetching chats and messages
*/